...
export default function PrivacyAnimation() {
    ...
    const images = [
        '/cookies-animation-1.webp',
        '/cookies-animation-2.webp',
        '/cookies-animation-3.webp',
        '/cookies-animation-4.webp',
        '/cookies-animation-5.webp',
        '/cookies-animation-6.webp',
        '/cookies-animation-7.webp',
      ];
